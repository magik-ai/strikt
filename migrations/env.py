"""Alembic environment: async engine, URL from settings, ``target_metadata = Base.metadata``."""
...
def get_url() -> str:
    """``sqlalchemy.url`` from alembic.ini / ``-x url=`` if given, else ``Settings.database_url``."""
