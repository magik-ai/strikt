...
STOPWORDS: frozenset[str] = frozenset(
    """
    the and for with that this from have has had was were are you your our not but all any
    can did does what when where which who why how did will would could should about into
    over than then them they there their been being also just very more most some such
    only own same too its it's his her him she he we me my i a an of to in on at by is be as
    or if do so no yes it up out off
    и в во на не что это как так с со по за от до из для при но или же уже ещё еще бы ли
    да нет он она оно они мы вы я ты мне мой моя мое мои меня тебя его её ее их нас вас
    был была было были быть есть был у о об про к ко без над под между через
    то те та тот эта эти этот этого этой этом тут там где когда куда почему зачем чем
    """.split()
)
